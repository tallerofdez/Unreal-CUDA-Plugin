...
#define UE_PROJECT_NAME UnrealCUDAPlugin
#define UE_TARGET_NAME UnrealCUDAPluginEditor
#define UE_MODULE_NAME "UnrealCUDAPlugin"
...
#define UNREALCUDAPLUGIN_API DLLEXPORT
